...
public class LoggingAspect {
	...
	public void beforeAdvice(JoinPoint joinPoint) {
		logger.info("************Reminder Aspect @Before ************");
	...
	public void afterAdvice(JoinPoint joinPoint) {
		logger.info("************Reminder Aspect @After ************");
		logger.debug("Method Name : " + joinPoint.getSignature().getName());
		logger.debug("Method Args : " + Arrays.toString(joinPoint.getArgs()));
		logger.info("*********************************");
	}
	...
	public void afterReturningAdvice(JoinPoint joinPoint, Object result) {
		logger.info("************Reminder Aspect @AfterReturning ************");
		logger.debug("Method Name : " + joinPoint.getSignature().getName());
	...
	public void afterThrowingAdvice(JoinPoint joinPoint, Throwable error) {
		logger.info("************Reminder Aspect @AfterThrowing ************");
		logger.debug("Method Name : " + joinPoint.getSignature().getName());
		logger.debug("Method arguments : " + Arrays.toString(joinPoint.getArgs()));
